...
def guardar_transcripcion():
    ...
    if texto_transcrito:
        try:
            ...
            messagebox.showinfo("Guardado", "La transcribir se ha guardado exitosamente en la base de datos.")
        ...
        messagebox.showwarning("Advertencia", "No hay ninguna transcribir para guardar.")
...
# Crear etiqueta y entrada para el nombre de usuario
usuario_label = tk.Label(ventana_login, text="Usuario:", fg="white", bg=fondo_ventana)
usuario_label.pack()
usuario_label.place(x=30, y=160)
usuario_entry = tk.Entry(ventana_login, fg="white", bg=fondo_entrada, insertbackground="white")
usuario_entry.pack()
usuario_entry.place(x=125, y=160)

# Crear etiqueta y entrada para la contraseña
contrasena_label = tk.Label(ventana_login, text="Contraseña:", fg="white", bg=fondo_ventana)
contrasena_label.pack()
contrasena_label.place(x=30, y=220)
contrasena_entry = tk.Entry(ventana_login, show="*", fg="white", bg=fondo_entrada, insertbackground="white")
contrasena_entry.pack()
contrasena_entry.place(x=125, y=220)

# Botón "Iniciar Sesión"
boton_iniciar_sesion = tk.Button(ventana_login, text="Iniciar Sesión", command=iniciar_sesion, fg="white",
                                  cursor="hand2", relief="flat", bg=fondo_entrar,
                                  font=("Bahnschrift Light", 11, "bold"))
boton_iniciar_sesion.pack()
boton_iniciar_sesion.place(x=50, y=300)
